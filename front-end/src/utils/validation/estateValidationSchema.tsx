...
const estateValidationSchema = Yup.object({
    ...
    area: Yup.number().moreThan(0, "Area must be greater than 0").required("Area is required").typeError("Invalid input"),
    roomsCount: Yup.number().moreThan(0, "Rooms count must be greater than 0").required("Rooms count is required").typeError("Invalid input"),
    price: Yup.number().moreThan(0, "Price must be greater than 0").required("Price is required").typeError("Invalid input"),
});
